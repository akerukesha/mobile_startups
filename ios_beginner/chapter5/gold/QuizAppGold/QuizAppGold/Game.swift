...
struct Constants{
    ...
    static let resultSegue = "ShowResult"
...
struct Game{
    ...
    mutating func checkAnswer(answerIndex: Int) -> Bool {
        ...
        print("index: \(index), answerIndex: \(answerIndex), answer: \(Constants.questions[index].options[answerIndex]), correct: \(Constants.answers[index])")
